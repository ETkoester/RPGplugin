package com.minecraft.rpgplugin.advancement;

import com.minecraft.rpgplugin.RPGplugin;
import com.minecraft.rpgplugin.SubPlugin;
...
public final class Advancement implements SubPlugin {
    ...
    private void cleanAdvancements() {
        ...
        while (advancements.hasNext()) {
            ...
            if ("rpgplugin".equals(namespacedKey.getNamespace())) {
